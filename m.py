...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @JAAT_YT."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @JAAT_YT 🙇."
    bot.reply_to(message, response)
...
Buy From :- @JAAT_YT//KAPIL DAHIYA
Official Channel :- https://t.me/DAHIYA_OP
'''
...
🤖Try To Run This Command : /help KAPIL DAHIYA
✅BUY :- @JAAT_YT'''
    bot.reply_to(message, response)
